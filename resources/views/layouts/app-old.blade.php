...
<body>
    ...
    <div class="sidebar">
        <div class="sidebar-brand">
            ...
            <h2><span class="las la-clinic-medical"></span> <span>Admin</span></h2>
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="{{ route('enroll.index') }}"><span class="las la-user"></span>
                        <span>Student Registration</span></a>
                </li>


                <li>
                    <a href="{{ route('course.index') }}"><span class="las la-book-medical"></span>
    ...
    <div class="main-content">
        <header>
            ...
            <div class="action">
                ...
                <div class="menu">
                    {{-- <h3>{{ Auth::user()->name }}<br><span>Administrator</span></h3> --}}
                    <ul>
                        <li><img src="admin/icons/user.png" alt=""><a href="#">My Profile</a></li>
                        <li><img src="admin/icons/edit.png" alt=""><a href="#">Edit Profile</a></li>
